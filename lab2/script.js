...
require([
  ...
  //maibacnho
  map.add(createGeoJsonLayer("mainho/mai_Bac_nho", blockRenderer(0.22, "#8B0000")));
  map.add(createGeoJsonLayer("mainho/mai_Bac_nho copy", blockRenderer(0.22, "#8B0000")));
  map.add(createGeoJsonLayer("mainho/mai_Nam_nho", blockRenderer(0.22, "#8B0000")));
  map.add(createGeoJsonLayer("mainho/mai_Nam_nho copy", blockRenderer(0.22, "#8B0000")));
  map.add(
