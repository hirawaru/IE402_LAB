...
export function createWindowF1Renderer({ href, heading, tilt = 0, roll = 0, width = 1, height = 1, depth = 0.3 }) {
    return {
        type: "simple",
        symbol: {
            type: "point-3d",
...
export function createWindowCornerFloor2Renderer({href, width, height, depth, heading, roll = 0}) {
    return {
        type: "simple",
        symbol: {
            type: "point-3d", 
...
export function createGLBRenderer({ href, width, height, depth, color, heading, tilt = 0, roll = 0 }) {
    return {
        type: "simple",
        symbol: {
            type: "point-3d", 
